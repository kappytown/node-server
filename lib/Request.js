...
class Request {
	...
	constructor(req) {
		...
		this.userId 	= null;											// Initialize as null
		this.db 		= null; 										// Will hold the database connection, using dependency injection, to be shared by all controllers
	}
	...
	async parseBody() {
		return new Promise((resolve, reject) => {
			...
			this.req.on('data', chunk => {
				...
				if (body.length >  process.env.UPLOAD_MAX_SIZE) {
